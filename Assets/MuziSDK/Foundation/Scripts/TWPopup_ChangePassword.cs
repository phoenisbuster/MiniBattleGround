...
public class TWPopup_ChangePassword : TWBoard
{
    ...
    [SerializeField] TMP_Text stage1_warningText_oldPass;
    ...
    void ResetWarnings()
    {
        stage1_warningText_oldPass.text =
    ...
    public async void OnClickRequestOTP(bool isResend = false)
    {
        ...
        try
        {
            ...
            await client.RequestOtpAsync(new Muziverse.Proto.User.Api.User.ChangeIdentity.RequestOtpIdentity { Context = ChangeIdentityContext.ChangePassword }, FoundationManager.metadata);
    ...
    async void ConfirmPassword()
    {
        ...
        try
        {
            ...
            {
                ChangePassword = new ChangeIdentityRequest.Types.ChangePasswordRequest
                {
                    NewPassword = inputFieldNewpass.text,
                    OldPassword = inputFieldOldPass.text,
                    OtpCode = s
                },
                Context = ChangeIdentityContext.ChangePassword
    ...
    private void Update()
    {
        ...
        {
            if (inputFieldOldPass.isFocused)
    ...
    bool Stage1_ReCheckInstructions()
    {
        ...
        if(string.IsNullOrEmpty(inputFieldOldPass.text))
        {
