...
namespace Opsive.UltimateCharacterController.Objects
{
    ...
    public class MuziMovingPlatform : StateBehavior, IKinematicObject, IInteractableTarget
    {
        /// <summary>
        ...
        /// </summary>
        /// 
        public void SetHardTarget(int index, float timeMove=10)
        {
            //gameObject.SetActive(false);
            this.enabled = false;
            m_MoveTime = 0;
            m_NextWaypoint = index;
            m_PreviousWaypoint = (index - 1 + Waypoints.Length) % Waypoints.Length;
            TargetWaypoint = index;
            transform.position = m_Waypoints[m_PreviousWaypoint].Transform.position;
            transform.rotation = m_Waypoints[m_PreviousWaypoint].Transform.rotation;
            m_OriginalRotation = m_Waypoints[m_PreviousWaypoint].Transform.rotation;
            ...
            //MovementSpeed = m_NextWaypointDistance /(3* timeMove);
        ...
        {
            MovementType = PathMovementType.Target;
            base.Awake();
