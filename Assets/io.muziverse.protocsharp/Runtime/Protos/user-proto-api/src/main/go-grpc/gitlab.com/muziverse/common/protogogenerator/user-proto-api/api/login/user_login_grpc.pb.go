...
type UserLoginServiceClient interface {
	Login(ctx context.Context, in *UserAccessRequest, opts ...grpc.CallOption) (*UserAccessResponse, error)
}
...
func (c *userLoginServiceClient) Login(ctx context.Context, in *UserAccessRequest, opts ...grpc.CallOption) (*UserAccessResponse, error) {
...
type UserLoginServiceServer interface {
	Login(context.Context, *UserAccessRequest) (*UserAccessResponse, error)
...
func (UnimplementedUserLoginServiceServer) Login(context.Context, *UserAccessRequest) (*UserAccessResponse, error) {
