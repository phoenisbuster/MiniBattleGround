...
type UserWalletChallengeServiceClient interface {
	VerifyWalletConsent(ctx context.Context, in *wallet.UserWalletConsentRequest, opts ...grpc.CallOption) (*login.UserAccessResponse, error)
}
...
func (c *userWalletChallengeServiceClient) VerifyWalletConsent(ctx context.Context, in *wallet.UserWalletConsentRequest, opts ...grpc.CallOption) (*login.UserAccessResponse, error) {
	out := new(login.UserAccessResponse)
...
type UserWalletChallengeServiceServer interface {
	VerifyWalletConsent(context.Context, *wallet.UserWalletConsentRequest) (*login.UserAccessResponse, error)
...
func (UnimplementedUserWalletChallengeServiceServer) VerifyWalletConsent(context.Context, *wallet.UserWalletConsentRequest) (*login.UserAccessResponse, error) {
