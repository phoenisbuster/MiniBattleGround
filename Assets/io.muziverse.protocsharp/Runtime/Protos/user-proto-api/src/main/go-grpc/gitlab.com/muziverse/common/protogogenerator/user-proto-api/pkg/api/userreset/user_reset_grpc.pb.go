...
type UserResetServiceClient interface {
	...
	ResendResetPasswordCode(ctx context.Context, in *ResetPasswordCodeRequest, opts ...grpc.CallOption) (*domain.AccessFlowResponse, error)
}
...
func (c *userResetServiceClient) ResendResetPasswordCode(ctx context.Context, in *ResetPasswordCodeRequest, opts ...grpc.CallOption) (*domain.AccessFlowResponse, error) {
	out := new(domain.AccessFlowResponse)
	err := c.cc.Invoke(ctx, "/identity.activation.UserResetService/ResendResetPasswordCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserResetServiceServer interface {
	...
	ResendResetPasswordCode(context.Context, *ResetPasswordCodeRequest) (*domain.AccessFlowResponse, error)
...
func (UnimplementedUserResetServiceServer) ResendResetPasswordCode(context.Context, *ResetPasswordCodeRequest) (*domain.AccessFlowResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResendResetPasswordCode not implemented")
}
...
func _UserResetService_ResendResetPasswordCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResetPasswordCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserResetServiceServer).ResendResetPasswordCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identity.activation.UserResetService/ResendResetPasswordCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserResetServiceServer).ResendResetPasswordCode(ctx, req.(*ResetPasswordCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserResetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResendResetPasswordCode",
			Handler:    _UserResetService_ResendResetPasswordCode_Handler,
		},
	},
