...
type UserInventoryServiceClient interface {
	...
	GetAllCollection(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListItemCollectionResponse, error)
}
...
func (c *userInventoryServiceClient) GetAllCollection(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListItemCollectionResponse, error) {
	out := new(ListItemCollectionResponse)
	err := c.cc.Invoke(ctx, "/useractivity.inventory.UserInventoryService/GetAllCollection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserInventoryServiceServer interface {
	...
	GetAllCollection(context.Context, *emptypb.Empty) (*ListItemCollectionResponse, error)
...
func (UnimplementedUserInventoryServiceServer) GetAllCollection(context.Context, *emptypb.Empty) (*ListItemCollectionResponse, error) {
...
func _UserInventoryService_GetAllCollection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserInventoryServiceServer).GetAllCollection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/useractivity.inventory.UserInventoryService/GetAllCollection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserInventoryServiceServer).GetAllCollection(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserInventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserInventoryService_GetAllCollection_Handler,
		},
	},
