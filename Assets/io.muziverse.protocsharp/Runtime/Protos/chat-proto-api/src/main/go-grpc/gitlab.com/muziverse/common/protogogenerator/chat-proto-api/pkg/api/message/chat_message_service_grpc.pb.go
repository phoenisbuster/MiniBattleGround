...
type ChatMessageServiceClient interface {
	...
	Receive(ctx context.Context, in *domain.ReceiveMessageRequest, opts ...grpc.CallOption) (ChatMessageService_ReceiveClient, error)
}
...
func (c *chatMessageServiceClient) Receive(ctx context.Context, in *domain.ReceiveMessageRequest, opts ...grpc.CallOption) (ChatMessageService_ReceiveClient, error) {
...
type ChatMessageServiceServer interface {
	...
	Receive(*domain.ReceiveMessageRequest, ChatMessageService_ReceiveServer) error
...
func (UnimplementedChatMessageServiceServer) Receive(*domain.ReceiveMessageRequest, ChatMessageService_ReceiveServer) error {
...
func _ChatMessageService_Receive_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(domain.ReceiveMessageRequest)
