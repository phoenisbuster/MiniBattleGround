...
namespace Opsive.Shared.Input
{
    ...
    public class UnityInput : PlayerInput
    {
        ...
        [Tooltip("Should the cursor be enabled when the right mouse is clicked?")]
        [SerializeField] protected bool m_EnableCursorWithMouseRightClick = true;
        ...
        public bool EnableCursorWithouseRightClick { get { return m_EnableCursorWithMouseRightClick; } set { m_EnableCursorWithMouseRightClick = value; } }
        ...
        private void LateUpdate()
        {
            ...
            if (m_EnableCursorWithEscape && UnityEngine.Input.GetKeyDown(KeyCode.Mouse1))
            {
                Cursor.lockState = CursorLockMode.None;
                Cursor.visible = true;
                if (m_PreventLookVectorChanges)
