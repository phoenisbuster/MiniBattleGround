...
namespace Opsive.UltimateCharacterController.Game
{
    ...
    public class LayerManager : MonoBehaviour
    {
        ...
        // [CUONG] layers
        private const int InvisibleNetworkBoundaryLayer = 16;
        ...
        public static int InvisibleNetworkBoundary { get { return InvisibleNetworkBoundaryLayer; } }
        ...
        private void Awake()
        {
            ...
            Physics.IgnoreLayerCollision(Character, InvisibleNetworkBoundary);
        }
