...
#pragma warning restore 0649
        ...
        private void PrepareVerticalOffsetLists()
        {
            ...
            if (m_FootstepMode == FootstepPlacementMode.CameraBob) {
                ...
                for (int i = 0; i < m_Feet.Length; ++i) {
                    if (m_Feet[i].Object != null)
                    {
                        m_LastVerticalOffset[i] = m_VerticalOffset[i] =
                            m_Transform.InverseTransformPoint(m_Feet[i].Object.position).y;
                        m_UpCount[i] = 0;
                    }
                }
            }
        ...
        // IEnumerator waitSettingsFootStep
        ...
        private void DetectBodyStep()
        {
            for (int i = 0; i < m_Feet.Length; ++i)
            {
                if (m_Feet[i].Object == null) continue;
